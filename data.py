...
class YaScooterOrderPageData:
    data_sets = {
        'data_set1': {
            ...
            'address': 'Лазурная улица',
            'subway_name': 'Тверская',
            'telepthone_number': '79201917316',
            'date': '11.11.2025',
            'rental_period': 0,
            'color': [0],
            'comment_for_courier': 'ААА',
            'description': 'Корректные данные'
        },
        'data_set2':
            {'first_name': 'Анастасия',
             'last_name': 'Половникова',
             'address': 'Калининская улица',
             'subway_name': 'Лубянка',
             'telepthone_number': '89005553535',
             'date': '11.11.2025',
             'rental_period': 1,
             'color': [0, 1],
             'comment_for_courier': 'БББ',
             'description': 'Корректные данные'
             },
    }