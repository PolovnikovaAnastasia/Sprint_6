...
class TestYaScooterOrderPage:
    ...
    def test_order_page_first_name_input_incorrect_show_error_message(self, driver):
        ...
        ya_scooter_order_page.test_go_to_site(Urls.ORDER_PAGE)
        ya_scooter_home_page = YaScooterHomePage(driver)
        ya_scooter_home_page.test_click_cookie_accept()
        ya_scooter_order_page.test_input_first_name('NNN')
        ya_scooter_order_page.test_go_next()
    ...
    def test_order_page_last_name_input_incorrect_show_error_message(self, driver):
        ...
        ya_scooter_home_page = YaScooterHomePage(driver)
        ya_scooter_home_page.test_click_cookie_accept()
        ya_scooter_order_page.test_input_last_name('NNN')
        ya_scooter_order_page.test_go_next()
        assert ya_scooter_order_page.test_INCORRECT_FIRST_NAME_MESSAGE().is_displayed()
    ...
    def test_order_page_address_input_incorrect_show_error_message(self, driver):
        ...
        ya_scooter_home_page = YaScooterHomePage(driver)
        ya_scooter_home_page.test_click_cookie_accept()
        ya_scooter_order_page.test_input_address('NNN')
        ya_scooter_order_page.test_go_next()
    ...
    def test_order_page_telephone_number_input_incorrect_show_error_message(self, driver):
        ...
        ya_scooter_home_page = YaScooterHomePage(driver)
        ya_scooter_home_page.test_click_cookie_accept()
        ya_scooter_order_page.test_input_telephone_number('NNN')
        ya_scooter_order_page.test_go_next()
    ...
    def test_order_page_go_to_choose_scooter_user_data_correct_open_about_rent(self, driver):
        ...
        ya_scooter_home_page = YaScooterHomePage(driver)
        ya_scooter_home_page.test_click_cookie_accept()
        ya_scooter_order_page.test_fill_user_data(order_data.data_sets['data_set1'])
        ya_scooter_order_page.test_go_next()
        assert len(ya_scooter_order_page.test_len_ORDER_BUTTON()) > 0
    ...
    def test_order_page_about_rent_input_correct_data_and_order_show_order_number(self, driver, data_set):
        ...
        ya_scooter_home_page = YaScooterHomePage(driver)
        ya_scooter_home_page.test_click_cookie_accept()
        ya_scooter_order_page.test_fill_user_data(order_data.data_sets[data_set])
        ya_scooter_order_page.test_go_next()
        ya_scooter_order_page.test_fill_rent_data(order_data.data_sets[data_set])
        ya_scooter_order_page.test_click_order()
        ya_scooter_order_page.test_click_accept_order()
        assert len(ya_scooter_order_page.test_len_ORDER_COMPLETED_INFO()) > 0
    ...
    def test_order_page_create_order_and_go_order_status(self, driver, data_set):
        ...
        ya_scooter_order_page.test_click_order()
        ya_scooter_order_page.test_click_accept_order()
        order_number = ya_scooter_order_page.test_get_order_number()
        ya_scooter_order_page.test_click_go_to_status()
        current_url = ya_scooter_order_page.test_current_url()
